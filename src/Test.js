...
const Test = () => {
  ...
  return (
    <TestContainer>
      ...
      <Body>
        <p>
          직업과관련된 두 개의 가치 중에서 자신에게 더 중요한 가치에 표시하세요. 가치의 뜻을 잘
          모르겠다면 문항 아래에 있는 가치의 설명을 확인해보세요.
        </p>
      ...
      <Footer>
        <button name="prev" onClick={e => handleClick(e)}>
          이전
        </button>
        <button name="next" disabled={false} onClick={e => handleClick(e)}>
          다음
        </button>
      </Footer>
    </TestContainer>
